...
<head>
    ...
    <link rel="stylesheet" href="./style/sinup-user.css">
</head>
<body>
    <div id="app">
    ...
    <div class="iconselect">
        ...
        <div class="komokumei">生年月日</div>
            ...
            <div class="komokumei">ニックネーム</div>
            <div class="nickname">
            <input type="text"class="textbox">
        </div>

        
            <div class="komokumei">メールアドレス</div>
            <div class="mailaddress">
            <input type="text"class="textbox">
        </div>

        
            <div class="komokumei">パスワード</div>
            <div class="password">
            <input type="texx"class="textbox">
        </div>

        
            <div class="komokumei">ひとこと</div>
            <div class="hitokoto">
